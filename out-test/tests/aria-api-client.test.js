...
(0, node_test_1.describe)('AriaApiClient.mapProject', () => {
    ...
    (0, node_test_1.it)('normalizes url/url_apex from uppercase and lowercase fields', () => {
        const client = makeClient();
...
(0, node_test_1.describe)('AriaApiClient.mapEndpoint', () => {
    ...
    (0, node_test_1.it)('normalizes endpoint url/url_apex from uppercase and lowercase fields', () => {
        const client = makeClient();
