...
exports.SqlPreviewResultViewProvider = void 0;
...
class SqlPreviewResultViewProvider {
    onAction;
    view;
    state = { title: 'ARIA Query Result', loading: false };
...
exports.SqlPreviewResultViewProvider = SqlPreviewResultViewProvider;
