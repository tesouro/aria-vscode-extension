...
function buildContextMessages(data) {
    const messages = [];
    ...
    if (data.tablesContext) {
        ...
        messages.push({ role: 'user', content: 'AVISO: O projeto identificado nao possui endpoints com banco externo definido.\n' +
